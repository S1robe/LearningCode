; *****************************************************************
;  Assignment: 3
;  Description: This Program takes preprogramed values and performs various calculations on them.e
...
; -----
; unsigned byte multiplication  ;here
;	wAns11 = bNum2 * bNum3
	mov	al, byte [bNum2]
	mul	byte [bNum3]
	mov	word [wAns11], ax
...
;	wRem21 = dAns14 % wNum1		;;here, gives -43 should be 186, these are not bit equal
	mov	word [wRem21], dx
...
; -----
; signed double word multiplication		;;here should be -57319865: debugger prints 4237647431, these are the same bitwise
;	qAns14  = dNum5 * dNum6
	mov	eax, dword [dNum5]
	imul	dword [dNum6]
...
;	dqAns14  = qNum6 * qNum7 
	...
	mov	qword [dqAns14+8], rax
	
;	dqAns15  = qNum5 * qNum8 
	mov	rax, qword [qNum5]
	imul	qword [qNum8]
	mov	qword [dqAns15], rax
	mov	qword [dqAns15+8], rax
...
;	qAns18 = dqAns11 / qNum3    
	mov	rax, qword [dqAns11]   ;; lo
	mov	rdx, qword [dqAns11+8] ;; hi
	div	qword [qNum3]
...
;	qAns21 = dqAns12 / qNum8
	mov	rax, qword [dqAns12]   ;;low
	mov	rdx, qword [dqAns12+8] ;; hi
	idiv	qword [qNum8]
	mov	qword [qAns21], rax
	
;	qRem21 = dqAns12 % qNum8			;;here
